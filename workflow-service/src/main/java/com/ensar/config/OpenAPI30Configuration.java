...
//@formatter:off
@OpenAPIDefinition(
        info = @Info(title = "Products API", version = "${api.version}",
                contact = @Contact(name = "Ensar", email = "api@ensarsolutions.com", url = "https://www.ensarsolutions.com"),
                license = @License(name = "Apache 2.0", url = "https://www.apache.org/licenses/LICENSE-2.0"), termsOfService = "${tos.uri}",
                description = "${api.description}"),
        servers = {
                @Server(url = "http://localhost:8082", description = "Development"),
